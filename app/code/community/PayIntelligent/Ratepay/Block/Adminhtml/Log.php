...
class PayIntelligent_Ratepay_Block_Adminhtml_Log
    extends PayIntelligent_Ratepay_Block_Adminhtml_Logs_Grid
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
   ...
   /**
    ...
    {
        return !Mage::helper('ratepay/payment')->isRatepayPayment($this->getOrder()->getPayment()->getMethod());
    }
    ...
    {
        $log = Mage::getModel('ratepay/logging')->load($this->getRequest()->getParam('log_id'));
