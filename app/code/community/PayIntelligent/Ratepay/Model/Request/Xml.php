...
class PayIntelligent_Ratepay_Model_Request_Xml extends SimpleXMLElement
{
    /**
     * This method add a new child element with a cdata tag arround to a PayIntelligent_Ratepay_Model_Xml object
     * 
     * @param string $sName
     * @param string $sValue
